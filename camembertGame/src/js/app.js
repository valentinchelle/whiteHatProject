window.App = {
  ...
  createContract: function () {
    ...
    // This creates a new Roulette Game.
    App.contracts.Roulette.new(0, { from: parieur, gas: 6000000 }).then(function (instance) {
  ...
  actualiserInfos: function () {
    ...
    web3.eth.getBalance(App.instances.roulette.contract.address, function (error, result) {
      ...
      App.instances.roulette.contract.last_winner.call(function (error, result) {
      if (error) {
        console.log(error);
      } else {
  ...
  bet: function () {
    ...
    App.instances.roulette.bet({ from: parieur, value: web3.toWei(mise, "ether"), gas: 2000000 }).then(function (result, error) {
      console.log(result);
      App.actualiserInfos();
